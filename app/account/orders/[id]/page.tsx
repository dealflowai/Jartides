      ...
      {order.status === "awaiting_payment" && (
        <div className="rounded-xl border border-amber-300 bg-amber-50 p-5">
          ...
          <p className="mt-1 text-sm text-amber-800">
            Your order is reserved but won&apos;t ship until payment is received. Buyers worldwide pay via PayPal; Canadian customers via Interac E-Transfer. Follow the steps to complete your payment.
          </p>
          <Link
